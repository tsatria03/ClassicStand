...
- [Plan: mean customer consequences](project_plan_mean_customer_consequences.md) — DONE in 3.6 (Direction B): un-calmed mean refuses to pay + rep×2 + badmouth ripple (−5s patience to others, −2 rep); talk-calming (~25%/chat) converts them to normal; config in customers.table [mean].
